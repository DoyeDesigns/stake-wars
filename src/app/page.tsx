  ...
  return (
    <div className='bg-[url("/welcome-background.png")] bg-cover h-[100vh] flex flex-col bg-background  justify-center items-center'>
      <div className='flex flex-col justify-center items-center'>
        ...
        <button className="btn !bg-primary border-none inline-flex items-center gap-2 text-sm font-bold !rounded-[5px] text-white w-[307px] h-[47px] mb-2 mt-[77px]">About Bonkwars <Image src='/external-link.png' alt='external-link' width={24} height={24}/></button>
