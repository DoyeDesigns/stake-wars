  ...
  return (
    <div className='bg-[url("/welcome-background.png")] bg-cover h-[100vh] flex flex-col bg-background  justify-center items-center'>
      <div className='flex flex-col justify-center items-center'>
        ...
        <p className='w-[300px] text-white'>Tip : “Sometimes taking damage early pays off later. Learn to play for the long game!”</p>
        ...
        <Link href="/play" className="btn border-none hover:no-underline bg-white text-sm font-bold rounded-[5px] test-sm text-primary w-[307px] h-[47px]">Get Started</Link>
        <HowToPlay textSize={'26'} iconSize={24} />
      </div>
    </div>
  )
}
